...
if (isset($_GET['message']) && $_GET['message'] = 'xmlMvtReceived') $error = "<h2>Fichier reçu !</h2>";
if (isset($_GET['message']) && $_GET['message'] = 'cxvMvtReceived') $error = "<h2>Fichier reçu !</h2>";
if (isset($_GET['message']) && $_GET['message'] = 'xmlKataReceived') $error = "<h2>Fichier reçu !</h2>";
if (isset($_GET['message']) && $_GET['message'] = 'csvKataReceived') $error = "<h2>Fichier reçu !</h2>";
if (isset($_GET['message']) && $_GET['message'] = 'xmlGrdReceived') $error = "<h2>Fichier reçu !</h2>";
if (isset($_GET['message']) && $_GET['message'] = 'xmlGrdReceived') $error = "<h2>Fichier reçu !</h2>";
if (isset($_GET['error']) && $_GET['error'] = 'dataBaseError') $error = "<h2>Erreur de connexion à la BDD</h2>";
